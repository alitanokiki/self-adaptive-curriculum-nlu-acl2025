...
selected_indices = random.sample(train_indices, 64)

new_train_dataset = train_dataset.select(selected_indices)
...
train_loader = DataLoader(new_train_dataset, batch_size=16, shuffle=True, collate_fn=collate_fn, generator=torch.Generator().manual_seed(seed))
