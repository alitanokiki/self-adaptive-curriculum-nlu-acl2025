...
sorted_cut_dataset = sorted_train_dataset.select(range(64))
...
train_loader = DataLoader(sorted_cut_dataset, batch_size=batch_size, shuffle=False, collate_fn=collate_fn)
