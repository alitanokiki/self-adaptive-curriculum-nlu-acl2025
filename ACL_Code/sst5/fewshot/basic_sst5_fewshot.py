...
indices = random.sample(range(len(train_dataset)), 64)

train_dataset = Subset(train_dataset, indices)

train_loader = DataLoader(train_dataset, batch_size=16, shuffle=True, collate_fn=collate_fn, generator=torch.Generator().manual_seed(seed))
