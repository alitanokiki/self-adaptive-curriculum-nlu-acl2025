...
random_indices = random.sample(range(len(train_dataset)), 64)

subset_dataset = train_dataset.select(random_indices)

train_loader = DataLoader(subset_dataset, batch_size=16, shuffle=True, collate_fn=collate_fn)
